...
public class AuditoriaControle implements AuditoriaService, Serializable {
    ...
    public List<Comandas> listarComandas() {
        ...
        sb.append("select ")
                .append("tecomand AS COMANDA,sum(tequanti*EEPLQTB1) as TOTAL,testatus as STATUS,tecdmesa as MESA,pessoas_mesa as PESSOAS,tepedido as PEDIDO,prdescri as DESCRICAO ")
                .append("from  sosa98 ")
                ...
                .append(" group by tecomand,testatus,tecdmesa,pessoas_mesa,tepedido,prdescri")
